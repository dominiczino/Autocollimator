...
def findCrosshairCenter(filename):
    ...
    binerized=smoothed>np.percentile(smoothed, 96)
    ...
    centerImg=crosshairID>np.percentile(crosshairID, 99.96875)
    show(centerImg)

    return ndimage.center_of_mass(centerImg)


a=findCrosshairCenter('c.jpg')
b=findCrosshairCenter('d.jpg')
